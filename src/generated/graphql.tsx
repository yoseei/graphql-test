...
/** Account Object */
export type Account = Node & Record & {
  __typename?: 'Account';
...
/** Project Object */
export type Project = Node & Record & {
  __typename?: 'Project';
  createdAt: Scalars['DateTime'];
  /** プロジェクト作成者 */
...
export type ProjectMembership = Node & Record & {
...
export type UseCurrentAccountAccountFragment = { __typename?: 'Account', id: string, email: string, username: string };
